...
$(document).ready(function(){
	...
	var viewModel = new EntendaGreveViewModel(function() {
		...
		if (window.location.href.indexOf('#') != -1) {
			...
			if (topicoElId && topicoElId.indexOf("!")==-1) {
				if (topicoElId.indexOf("topico_")!=-1)
...
function getNoticias(apiURL, topico) {
	$.get(apiURL + "/topicos/" + topico.id + "/noticias/?limit=16", function(data) {
